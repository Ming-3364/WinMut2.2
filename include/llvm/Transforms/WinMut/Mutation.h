...
public:
  ...
  static bool classof(const Mutation *M) { return M->getKind() == MK_AOR; }
};
...
public:
  ...
  static bool classof(const Mutation *M) { return M->getKind() == MK_LOR; }
};

// COR
// Conditional Operator Replacement, e.g. a || b ---> a && b, which is reduced
// into ROR and LOR
class CORMut : public Mutation {
public:
  CORMut() : Mutation(MK_COR) {}

  static bool classof(const Mutation *M) { return M->getKind() == MK_COR; }
};
...
public:
  ...
  static bool classof(const Mutation *M) { return M->getKind() == MK_ROR; }
};
...
public:
  ...
  static bool classof(const Mutation *M) { return M->getKind() == MK_SOR; }
};

// STD
// Statement Deletion Operator: Delete (omit) a single statement, foo(a,b) --->
// <no-op>
...
public:
  ...
  static bool classof(const Mutation *M) { return M->getKind() == MK_STD; }
};
...
public:
  ...
  static bool classof(const Mutation *M) { return M->getKind() == MK_LVR; }
};
...
public:
  ...
  static bool classof(const Mutation *M) { return M->getKind() == MK_UOI; }
};
...
public:
  ...
  static bool classof(const Mutation *M) { return M->getKind() == MK_ROV; }
};
